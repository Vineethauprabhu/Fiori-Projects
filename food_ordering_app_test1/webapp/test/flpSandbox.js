		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Food Ordering App Demo",
									"targetURL": "#comapplexusfoodorderingapptest1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comapplexusfoodorderingapptest1-display": {
								"semanticObject": "comapplexusfoodorderingapptest1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.applexus.foodorderingapptest1",
									"url": sap.ui.require.toUrl("com/applexus/foodorderingapptest1")
								}
							}
						}
					}
