		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "My First Fiori App",
									"targetURL": "#comapplexusproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comapplexusproject1-display": {
								"semanticObject": "comapplexusproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.applexus.project1",
									"url": sap.ui.require.toUrl("com/applexus/project1")
								}
							}
						}
					}
