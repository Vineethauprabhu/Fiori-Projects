		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Table",
									"targetURL": "#comapplexustable1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comapplexustable1-display": {
								"semanticObject": "comapplexustable1",
								"action": "display",
								"description": "Table1",
								"title": "Table",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.applexus.table1",
									"url": sap.ui.require.toUrl("com/applexus/table1")
								}
							}
						}
					}
